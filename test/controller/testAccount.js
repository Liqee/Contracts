...
describe("Controller: Account", function () {
  ...
  describe("Account Equity", function () {
    describe("Liquidate Calculate Seize Tokens", function () {
      ...
      it("Should revert if either underlying price is unavailable in ControllerStock", async function () {
        const {
          controllerStock,
          mockPriceOracle,
          iToken0,
    ...
    describe("Calculate Account Equity", async function () {
      let controller, controllerStock, iToken0, iToken1;
      ...
      it("Should fail if the underlying price is unavailable in controllerStock ", async function () {
        // Use controllerStock
        await iToken0._setController(controllerStock.address);
        await iToken1._setController(controllerStock.address);
